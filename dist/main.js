var $77xIw$espree = require("espree");
var $77xIw$estraverse = require("estraverse");
...
parcelRegister("7TZWx", function(module, exports) {
...
var $1528c8cec63da9de$var$_vanillaJsMethods = $1528c8cec63da9de$var$_interopRequireDefault((parcelRequire("7TZWx")));
function $1528c8cec63da9de$var$_interopRequireDefault(obj) {
...
function $4559ecf940edc78d$var$getAST(data) {
    return $77xIw$espree.parse(data, {
        ecmaVersion: 2021,
        sourceType: "module",
        comment: true
    });
...
async function $4559ecf940edc78d$var$getDependedMethods(methodsFileData, baseMethods, generatedMethods, lineRef, outputStart, outputEnd) {
    ...
    $77xIw$estraverse.traverse(outputAst, {
        enter (node) {
...
async function $4559ecf940edc78d$var$generateAlternativeMethods(methodsToGenerate, methodsFileData) {
    ...
    $77xIw$estraverse.traverse(astMethods, {
        enter (node) {
            if (node.type === "MethodDefinition") {
                ...
                return $77xIw$estraverse.VisitorOption.Skip;
            }
        }
    });
...
async function $1528c8cec63da9de$var$plugin(source) {
    const methods = await $4559ecf940edc78d$exports.getJQueryMethodsFromSource(source);
    const generatedMethods = await $4559ecf940edc78d$exports.generateAlternativeMethods(methods, $1528c8cec63da9de$var$_vanillaJsMethods.default); // eslint-disable-next-line no-undef
...
window.ReplaceJquery = $1528c8cec63da9de$var$plugin;
